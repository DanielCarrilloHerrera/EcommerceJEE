					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Productos destacados</h2>
                                                ...
                                                if(Integer.parseInt(session.getAttribute("category").toString()) > 0){
                                                    datos= ProductoCad.listarProductosPorCategoria(session.getAttribute("moneda").toString(),
                                                            Integer.parseInt(session.getAttribute("category").toString()));
                                                }else{
								...
								<div class="single-products">
										...
										<div class="product-overlay <c:if test="${p.stock==0}"> grisfondo </c:if>">
											<div class="overlay-content">
												<h2>${sessionScope.moneda} s${p.precio}</h2>
												<p>${p.nombre}</p>
